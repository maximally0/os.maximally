        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {guildsData.map((guild) => (
            <PixelCard key={guild.id} className="text-center" glowColor="green">
              ...
              <h3 className="font-pixel text-xl text-neon-green mb-2">{guild.name}</h3>
              <p className="text-neon-blue font-pixel text-sm mb-3">{guild.mission}</p>
